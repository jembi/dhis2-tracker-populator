      ...
      it('should return the existing tracked entity instance ID', function (next) {
        ...
        var getTrackedEntityInstanceRequest = Sinon.match({
          ...
          qs: Sinon.match({
            ...
            filter: uniqueAttributeID + ':EQ:' + ATTRIBUTES[uniqueAttributeID]
          }),
          json: true
        });
...
describe('Populator with specified unique tracked entity attribute ID with multiple unique attributes', function () {
