...
Populator.prototype._processRow = function(row, next) {
  ...
  Async.waterfall([
    ...
    // Track the entity
    this._addTrackedEntity.bind(this, this._options.trackedEntityID, knownKeys, trackedEntityAttributes),
    // Enroll in the program
    this._enrollInProgram.bind(this, this._options.programID, knownKeys),
    // Add the event
    this._addEvent.bind(this, this._options.programID, this._options.stageID, knownKeys, dataElements)
  ], next);
};
...
Populator.prototype._addTrackedEntity = function(trackedEntityID, knownKeys, trackedEntityAttributes, next) {
...
Populator.prototype._enrollInProgram = function(programID, knownKeys, trackedEntityInstanceID, next) {
...
Populator.prototype._addEvent = function(programID, stageID, knownKeys, dataElements, trackedEntityInstanceID, next) {
