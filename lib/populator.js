  ...
  var request = Request.post({
    ...
    if (body.status !== 'SUCCESS') {
      if (body.conflicts.length === 1 && /non-unique/i.test(body.conflicts[0].value)) {
        ...
        return this._getTrackedEntityInstanceID(function(err, trackedEntityInstanceID) {
          if (err) {
            return next(err);
          }
          this._updateTrackedEntityInstance(trackedEntityInstanceID, next);
        }.bind(this));
      }
...
Populator.prototype._getTrackedEntityInstanceID = function(next) {
...
Populator.prototype._updateTrackedEntityInstance = function(trackedEntityInstanceID, next) {
